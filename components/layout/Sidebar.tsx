...
const navigation = [
  ...
  { name: 'Creator', href: '#', icon: UsersIcon, current: false },
    ...
    <>
      <div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          {/* Sidebar component, swap this element with another sidebar if you like */}
          <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-[#3B6EFF] px-6 pb-4">
            <div className="flex h-16 shrink-0 items-center justify-center">
              <img
                className="h-20 w-auto"
                src="https://pbs.twimg.com/profile_images/1633272756618895360/DHSBRn5d_400x400.jpg"
                alt="Sphere Labs"
              />
            </div>
            <nav className="flex flex-1 flex-col">
                      ...
                      <li key={item.name}>
                        <a
                          ...
                          className={classNames(
                            ...
                            'hover:border-white hover:border-2 hover:rounded-full hover:transparency-100'
                          )}
                        >
                          <item.icon
                            className={classNames(
          ...
          <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 bg-white px-4 sm:gap-x-6 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col flex-1 gap-x-4 self-stretch lg:gap-x-6">
              <div className="flex items-center gap-x-4 lg:gap-x-6 flex-row-reverse">
                ...
                <Menu as="div" className="relative border-black rouded-full pl-15 pr-15 pt-5 pb-5 ">
